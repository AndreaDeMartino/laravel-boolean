...
$(document).ready(function () {
  ...
  ****************************************************/
  ...
  var filter = $('#filter');
  var container = $('.students'); // Get protocol and url with window.location

  var apiUrl = window.location.protocol + '//' + window.location.host + '/api/students/genders'; // Handlebars

  var source = $('#student-template').html();
  var template = Handlebars.compile(source); // Filter on Select menu
...
__webpack_require__(/*! /Users/andrea/Desktop/Boolean/Consegne/laravel-boolean/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/andrea/Desktop/Boolean/Consegne/laravel-boolean/resources/sass/app.scss */"./resources/sass/app.scss");
